...
config.loans.emptyMsg = 'No hay ' + config.loans.status + ' préstamos';
...
config.messages.transferMsg = 'Has recibido dinero de ';
config.messages.giftMsg = '¡ [sender] te ha invitado una margarita de AGS Nasoft Wallet!';
config.messages.loanRequestMsg = 'Has solicitado un préstamo por €';
config.messages.loanRejectedMsg = 'Genera puntos y podrás ser eligible para un préstamo';
config.messages.loanRejectedOneMsg = '¡Lo sentimos! Tienes un préstamo reciente, necesitas esperar ';
config.messages.loanRejectedTwoMsg = ' minutos y ser así elegible para un préstamo!';
config.messages.loanAcceptedMsg = '¡Felicitaciones! Su préstamo ha sido aprobado!';
...
config.mailInvite.bodyInit = 'Echale un vistazo a la App AGS NASOFT Wallet  - Es realmente impresionante  con $100.00 MXN GRATIS, puedes comprar deliciosas bebidas   !';
config.mailInvite.bodyMid1 = 'El usuario mas activo en el wallet  ganará unos beats powerbeats blancos';
