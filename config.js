...
config.messages.transferRejectedOneMsg = 'Sorry,You have transfers in last hour, you need to wait ';
config.messages.transferRejectedTwoMsg = ' minutes for create new transacctions';
