...
config.messages.loanRejectedOneMsg = '¡Lo sentimos! Tienea un préstamo reciente, necesitas esperar para solicitar otro ';
config.messages.loanRejectedTwoMsg = ' minutos y ser elegible para un préstamo!';
